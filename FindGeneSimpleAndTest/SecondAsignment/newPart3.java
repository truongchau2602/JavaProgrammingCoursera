...
/**
 * Write a description of newPart3 here.
 * 
 * @author (your name) 
...
public class newPart3 {
    ...
    public int countCodon(String dna, String codon)
    {
        ...
        while (true)
        {
            start_index = dna.indexOf(codon,start_index);
            if (start_index==-1)
                break;
            count = count+1;
    ...
    public void testCount()
    {
        ...
        int numCTG = countCodon(dna,"CTG");
        System.out.println("Number of CTG in dna:"+numCTG);
    }
